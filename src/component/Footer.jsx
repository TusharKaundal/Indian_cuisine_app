    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        <div className={styles.section}>
          ...
          <p>
            Discover the rich and diverse flavors of India's culinary heritage
            with our authentic recipes and cooking guides.
          </p>
        </div>
        ...
        <div className={styles.section}>
          ...
          <Link to="/suggestor" className={styles.link}>
            Dish Suggester
          </Link>
        </div>
        ...
        <div className={styles.section}>
          ...
          <a href="mailto:info@indiancuisine.com" className={styles.link}>
            info@indiancuisine.com
          </a>
